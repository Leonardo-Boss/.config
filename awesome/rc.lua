...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "j",
        function ()
            awful.client.focus.global_bydirection("down", client.focus, true)
        end,
        {description = "focus client below", group = "client"}
    ),
    awful.key({ modkey,           }, "k",
        function ()
            awful.client.focus.global_bydirection("up", client.focus, true)
        end,
        {description = "focus client above", group = "client"}
    ),
    awful.key({ modkey,           }, "h",
        function ()
            awful.client.focus.global_bydirection("left", client.focus, true)
        end,
        {description = "focus client to the left", group = "client"}
    ),
    awful.key({ modkey,           }, "l",
        function ()
            awful.client.focus.global_bydirection("right", client.focus, true)
        end,
